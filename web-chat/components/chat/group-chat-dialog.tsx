              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex justify-center">
                  <div className="relative">
                    ...
                    <label htmlFor="group-icon-upload" className="absolute bottom-0 right-0 h-10 w-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-lg hover:bg-primary/90 transition-colors cursor-pointer">
